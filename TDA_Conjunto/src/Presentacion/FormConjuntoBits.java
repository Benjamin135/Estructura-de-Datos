...
public class FormConjuntoBits extends javax.swing.JFrame {
    ...
    private void cambiarLabel() {
        String operation = cbx_Operaciones.getSelectedItem().toString();
        switch(operation) {
            case "UNION" -> jLabel5.setText("A U B =");
            case "INTERSECCION" -> jLabel5.setText("A ∩ B =");
            case "DIFERENCIA" -> {
                if (opcion == 0) {
                    jLabel5.setText("A - B");
                } else if (opcion == 1) {
            ...
            case "DIFERENCIA SIMETRICA" -> jLabel5.setText("A \u2206 B =");
            case "SUBCONJUNTO" -> {
                if (opcion == 0) {
                    jLabel5.setText("A \u2286 B");
                } else if (opcion == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormConjuntoBits.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormConjuntoBits().setVisible(true);
            }
        });
    }
